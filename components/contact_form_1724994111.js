  ...
  <main class="flex justify-center align-center p-10">
    <div class="w-fit max-w-lg p-8 bg-white shadow-lg rounded-lg">
      <div>
        ...
        <p class="mt-3 text-black w-fit">We're here to help with all your goods-related needs</p>
      </div>
      <form @submit.prevent class="space-y-5 mt-5">
        ...
        <div>
          <label class="font-medium text-black">Company Name (Optional)</label>
        ...
        <div>
          <label class="font-medium text-black">What goods are you interested in?</label>
          <textarea
            required
