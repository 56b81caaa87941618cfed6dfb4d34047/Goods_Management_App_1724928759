        ...
        <nav id="nav-bar" class="bg-gradient-to-r from-pink-500 to-purple-600 bg-opacity-70 backdrop-filter backdrop-blur-lg py-4 shadow-lg">
            <div id="nav-container" class="flex flex-wrap items-center justify-between max-w-screen-xl px-6 mx-auto">
                ...
                <div id="menu-toggle-button" class="flex items-center lg:order-2">
                    <button id="collapse-button" data-collapse-toggle="mobile-menu-2" type="button" aria-controls="mobile-menu-2" aria-expanded="false" class="inline-flex items-center p-2 ml-1 text-sm text-white rounded-lg lg:hidden hover:bg-pink-400 focus:outline-none focus:ring-2 focus:ring-white">
                ...
                <div id="mobile-menu-2" class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1">
                    <ul id="nav-list" class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li id="nav-item-home">
                            <a href="#" aria-current="page" class="block py-2 pl-3 pr-4 text-white bg-pink-600 rounded-lg lg:bg-transparent lg:text-pink-200 lg:p-0 hover:text-white transition-colors duration-300">
                                Donation Tracking
                            </a>
                        </li>
                        <li id="nav-item-1">
                            <a href="#" class="block py-2 pl-3 pr-4 text-white rounded-lg hover:bg-pink-500 lg:hover:bg-transparent lg:hover:text-pink-200 lg:p-0 transition-colors duration-300">
                        ...
                        <li id="nav-item-3">
                            <a href="#" class="block py-2 pl-3 pr-4 text-white rounded-lg hover:bg-pink-500 lg:hover:bg-transparent lg:hover:text-pink-200 lg:p-0 transition-colors duration-300" data-mf-new="true">
